import { forwardRef, useMemo, createContext, Children, isValidElement, cloneElement, useCallback, useState, useEffect, useRef, useContext } from 'react';
...
var LiquidGlassView = forwardRef(
...
var LiquidGlassContainerView = forwardRef(function LiquidGlassContainerView2(props, ref) {
  ...
  return /* @__PURE__ */ jsx(ContainerContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: combinedClassName,
...
export { LiquidGlassContainerView, LiquidGlassView, isLiquidGlassSupported, useColorScheme, useContainerContext, useGlassEffect, useInteractive };
